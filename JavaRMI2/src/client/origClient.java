...
public class origClient extends AbstractScriptedSimpleTest {
	...
	public static void main(String[] args) throws Exception {
		...
		origClient client = new origClient("simpleTrips", carRentalCompanyName);
		client.run();
	}
	...
	public origClient(String scriptFile, String carRentalCompanyName) {
		super(scriptFile);
